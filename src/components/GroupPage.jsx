...
import TaskStatusPreview from "./dashboard/TaskStatusPreview"; // You’ll create this
const GroupPage = () => {
  ...
  const handleLeaveGroup = async () => {
    try {
      ...
      if (isAdmin) {
        const remainingMembers = group.members.filter((id) =>
          id !== currentUser.uid
        );
        ...
        alert(
          `You left the group. Admin rights transferred to another member.`,
        );
      } else {
        await updateDoc(groupRef, {
          members: arrayRemove(currentUser.uid),
